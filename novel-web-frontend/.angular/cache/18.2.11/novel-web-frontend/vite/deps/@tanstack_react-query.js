...
function useQueries(_a, queryClient) {
  ...
  React5.useSyncExternalStore(React5.useCallback((onStoreChange) => isRestoring ? noop2 : observer.subscribe(notifyManager.batchCalls(onStoreChange)), [observer, isRestoring]), () => observer.getCurrentResult(), () => observer.getCurrentResult());
  React5.useEffect(() => {
...
function useSuspenseQuery(options, queryClient) {
  ...
  return useBaseQuery(__spreadProps(__spreadValues({}, options), {
    enabled: true,
    suspense: true,
...
function useSuspenseQueries(options, queryClient) {
  return useQueries(__spreadProps(__spreadValues({}, options), {
