...
// Typography
@font-family-sans-serif: Segoe UI, Open Sans;
@font-family-serif: Segoe UI, PT Serif;
@font-family-monospace: Segoe UI, Monaco;
...
@btn-default-color: @brand-action;
@btn-default-bg: #fff;
@btn-default-border: @brand-action;
@btn-primary-color: #fff;
@btn-primary-bg: @brand-action;
