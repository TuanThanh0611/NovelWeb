...
.bg-primary {
    color: #fff;
    background-color: #0797a7
}

a.bg-primary:hover,
a.bg-primary:focus {
    background-color: #056b76
}
...
abbr[data-original-title] {
    cursor: help;
    border-bottom: 1px dotted #a8a6ae
}
