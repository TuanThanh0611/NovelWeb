...
export function createInjectable(factory, { providedIn = 'root' } = {}) {
    class _Injectable {
        ...
        static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.7", ngImport: i0, type: _Injectable, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
        static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "18.2.7", ngImport: i0, type: _Injectable, providedIn: providedIn === 'scoped' ? null : providedIn }); }
    }
    i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.7", ngImport: i0, type: _Injectable, decorators: [{
                type: Injectable,
