...
export class NgxControlError {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.7", ngImport: i0, type: NgxControlError, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "18.2.7", type: NgxControlError, isStandalone: true, selector: "[ngxControlError]", inputs: { track: ["ngxControlErrorTrack", "track"], control: ["ngxControlError", "control"], errorStateMatcher: ["ngxControlErrorErrorStateMatcher", "errorStateMatcher"], parent: ["ngxControlErrorParent", "parent"] }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.7", ngImport: i0, type: NgxControlError, decorators: [{
            type: Directive,
            args: [{
